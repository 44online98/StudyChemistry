...
extension String {
    ...
    var forSorting: String {
        let simple = folding(options: [.diacriticInsensitive, .widthInsensitive, .caseInsensitive], locale: Locale.current)
        let replaced = simple.replacingOccurrences(of: "đ", with: "d")
        let nonAlphaNumeric = CharacterSet.alphanumerics.inverted
        return replaced.components(separatedBy: nonAlphaNumeric).joined(separator: "")
    }
