//
//  ConfirmRechargeViewController.swift
//  PAVietNam
//
...
class ConfirmRechargeViewController: BaseSubViewController {
...
//            self.navigationController?.pushViewController(confirmRechargeView, animated: true)
    ...
    func setupView() {
        ...
        // tableView
        tableView.register(UINib(nibName: "ConfirmInputMoneyTableViewCell",bundle: nil), forCellReuseIdentifier: "ConfirmInputMoneyTableViewCell")
...
extension ConfirmRechargeViewController : UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        
    }
}

extension ConfirmRechargeViewController : UITableViewDataSource {
    // setup tableViewCell
    func tableView(_ tableView: UITableView, viewForHeaderInSection section: Int) -> UIView? {
        let view = View.init(width: self.view.width, height: 28, text: "Xác nhận lại thông tin")
        return view
    }
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "ConfirmInputMoneyTableViewCell", for: indexPath) as! ConfirmInputMoneyTableViewCell
        return cell
    }
}
