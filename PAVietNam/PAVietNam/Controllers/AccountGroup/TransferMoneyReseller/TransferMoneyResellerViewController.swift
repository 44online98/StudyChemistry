//
//  TransferMoneyResellerViewController.swift
//  PAVietNam
//
...
class TransferMoneyResellerViewController: BaseSubViewController {
    ...
    func setupView() {
        ...
        self.view.addConstraints(NSLayoutConstraint.constraints(
            ...
            options: [],
            metrics: ["top": STATUSBAR_HEIGHT + NAVBAR_HEIGHT, "height": 240],
            views: views))
    }
}

extension TransferMoneyResellerViewController : UITableViewDelegate {
    
}

extension TransferMoneyResellerViewController : UITableViewDataSource {
...
extension TransferMoneyResellerViewController: InputTextFieldTableViewCellDelegate {
