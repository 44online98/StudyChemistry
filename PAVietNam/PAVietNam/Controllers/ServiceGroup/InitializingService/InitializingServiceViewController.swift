//
//  InitializingServiceViewController.swift
//  PAVietNam
//
...
class InitializingServiceViewController: BaseSubViewController {
...
extension InitializingServiceViewController : UITableViewDelegate {
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        self.showActionSheetOptions(title: services[indexPath.row]["name"] as! String)
    }
}

extension InitializingServiceViewController : UITableViewDataSource {
