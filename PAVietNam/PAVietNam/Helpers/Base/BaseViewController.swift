...
class BaseViewController: UIViewController {
    ...
    private func setupNavigationBar(){
         // tintColor(bar button color)
         // barTintColor: background
         // titleTextAttributes (.foregroundColor color)

        navigationController?.navigationBar.tintColor           = AppColor.MAIN_COLOR
        navigationController?.navigationBar.barTintColor        = .white
        navigationController?.navigationBar.titleTextAttributes = [NSAttributedStringKey.foregroundColor: AppColor.MAIN_COLOR]
    }
